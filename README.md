...
**AI Coordination Language (AICL)** is a lightweight, declarative scripting language designed to facilitate communication and task orchestration between multiple AI agents. Using AICL, a **Parent AI** (or Supervisor) can issue instructions to agents, defining:
